...
#ifndef CPPDE_STEP_CHECKER_HPP
#define CPPDE_STEP_CHECKER_HPP

#include <stdexcept>
#include <cstdio>

#include "cppde_return_codes.hpp"
 ...
 * (see cppde_return_codes.hpp). Typical values set by this class:
 ...
 * @endcode
 *
 * @throw cppde::no_progress_error if limits exceeded
 */
class StepChecker {
public:
  /**
   ...
   *
   * @throw cppde::no_progress_error if
  ...
  // Return code using the CVODE flag scheme (see cppde_return_codes.hpp):
  //    0 = RC_SUCCESS
