/*
 ...
 Two inline helpers:
   ...
   cppde::chain_jac(J, S, J_theta, n_obs, n_out, n_diff, n_theta)
   ...
   cppde::chain_hess(H, J, S, S2, H_theta,
...
#ifndef CPPDE_CHAIN_BLAS_HPP
#define CPPDE_CHAIN_BLAS_HPP
