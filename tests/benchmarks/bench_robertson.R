## =================================================================
## Robertson test: all cppDE methods vs deSolve (bdf, vode, lsode)
## =================================================================
rm(list = ls(all.names = TRUE))

.workingDir <- file.path(tempdir(), "cppDE_bench_robertson")
...
# --- cppDE methods to test --------------------------------------------------
methods <- c("bdf", "rb4")

cat("\n============================================================\n")
cat("Compiling cppDE models for all methods\n")
cat("============================================================\n")
